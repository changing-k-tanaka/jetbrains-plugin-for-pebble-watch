...
[![Version](https://img.shields.io/jetbrains/plugin/v/30556.svg)](https://plugins.jetbrains.com/plugin/MARKETPLACE_ID)
[![Downloads](https://img.shields.io/jetbrains/plugin/d/30556.svg)](https://plugins.jetbrains.com/plugin/MARKETPLACE_ID)
...
- Using the IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "jetbrains-plugin-for-pebble-watch"</kbd> >
  <kbd>Install</kbd>
...
- Manually:
  ...
  Download the [latest release](https://github.com/changing-k-tanaka/jetbrains-plugin-for-pebble-watch/releases/latest) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>
